...
class Player(pygame.sprite.Sprite):
    def __init__(self, location, screenSize, speed):
      ...
      self.image = pygame.transform.scale_by(self.image, (screenSize[0]*0.415)/width)
    ...
    def update(self, directions, buttons, enemies, collectibles):      
      ...
      if keystate[pygame.K_a] or "LEFT" in directions:
        self.velocityX = -1 * self.speedX
      if keystate[pygame.K_d] or "RIGHT" in directions:
        self.velocityX = self.speedX
      if keystate[pygame.K_w] or "UP" in directions:
        self.velocityY = -1 * self.speedY
      if keystate[pygame.K_s] or "DOWN" in directions:
